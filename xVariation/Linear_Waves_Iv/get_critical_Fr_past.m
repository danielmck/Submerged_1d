function Fr_out = get_critical_Fr_past(theta, rho_p, rho_f, d, eta_f, alpha,tau0)
...
% form with single_Fr_stab and halving the potential span.
    ...
    while ((Fr_max-Fr_min)>Fr_tol)
        ...
        stab_out = single_Fr_stab_past(Fr_mid,crit_Iv,theta, rho_p, rho_f, d, eta_f, alpha,tau0);
